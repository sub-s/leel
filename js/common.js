...
window.onload = function(){
    ...
    const _con10 = document.querySelector(".content-area.con10 .innerWrapper");
    ...
    _con10.addEventListener("scroll",(ev)=>{
        ev.preventDefault();
        ...
        if(wt - videoTop >= 200){
            onePlay = true;
            _con10.querySelector("video").play();
        }
    })
    _conWrapper.addEventListener("wheel",(ev)=>{
        ...
        if(dy > 0){
            ...
            if(checked !== "w11" || _con10.scrollTop <= 0){
            ...
            if(checked == "w1"){
                ...
                resetCon10();
            }else if(checked == "w11" && _con10.scrollTop <= 0){
                resetCon11();
            }else{
                checkedEvent = false;
                delayTime = false;
    ...
    document.querySelector(".top-bottom").addEventListener("click",()=>{
        resetCon1();
        resetCon2();
        resetCon3();
        resetCon4();
...
const resetCon11 = ()=>{
    ...
    setTimeout(()=>{
        ...
        _con10.scrollTop = 0;
        onePlay = false;
        _con10.querySelector("video").pause();
    },800)
}
